...
export type Create_UserProfileMutation = { __typename?: 'Mutation', Create_UserProfile?: { __typename?: 'Profile', id?: string | null, createdAt?: any | null, updatedAt?: any | null, userId?: string | null, firstName?: string | null, lastName?: string | null, nationality?: string | null, nationalID?: string | null, dateOfBirth?: string | null } | null };
...
export const Create_UserProfileDocument = gql`
    mutation Create_UserProfile($firstName: String, $lastName: String, $nationality: String, $nationalID: String, $dateOfBirth: String) {
  Create_UserProfile(
    firstName: $firstName
    lastName: $lastName
