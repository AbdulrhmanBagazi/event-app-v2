...
import { getMany_Event_TypeDefs, getMany_Event_Query } from './getMany/getMany.events';
...
const Query = { ...list_Events_Query, ...getOne_Events_Query, ...getMany_Event_Query, ...eventjob_Events_Query };
